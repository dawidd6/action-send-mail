 ...
 */
export function isPlainText(value, isParam) {
 ...
 */
export function hasLongerLines(str, lineLength) {
 ...
 */
export function encodeWord(data, mimeWordEncoding, maxLength) {
 ...
 */
export function encodeWords(value, mimeWordEncoding, maxLength, encodeAll) {
    maxLength = maxLength || 0;
 ...
 */
export function foldLines(str, lineLength, afterSpace) {
    str = (str || '').toString();
 ...
 * @return Split string
 */
export function splitMimeEncodedString(str, maxlen) {
    const lines = [];
...
export function encodeURICharComponent(chr) {
    let res = '';

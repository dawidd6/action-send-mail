...
export declare type GetRoleCredentialsCommandInput = GetRoleCredentialsRequest;
export declare type GetRoleCredentialsCommandOutput = GetRoleCredentialsResponse & __MetadataBearer;
/**
